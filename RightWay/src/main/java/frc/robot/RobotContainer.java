...
private final XboxController xboxController0 = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ArticulateLift", new ArticulateLift( m_lift ));
    SmartDashboard.putData("ArticulateGrabber", new ArticulateGrabber( m_lift ));
    ...
    m_lift.setDefaultCommand(new ArticulateLift( m_lift ) );
